    ...
    <section class="sidebar">	
	  <div class="user-profile px-20 pt-15 pb-10">
		<div class="d-flex align-items-center">			
			...
			<div class="info">
				<a class="dropdown-toggle px-20" href="#">Johen Doe</a>
      ...
      <ul class="sidebar-menu" data-widget="tree">		
		...
		<li>
            <li><a href="withdraw"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Withdraw Funds</a></li>
        </li>
         <!-- --------------------------------- -->
		<li class="header">Widgets</li>
        <!-- -------------------------------- -->
        <li>
            <li><a href="transaction"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Transaction History</a></li>
        </li>
        <li>
