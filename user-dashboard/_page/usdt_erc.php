		    ...
		    <div class="box">
				...
				<div class="box-body">
					...
					<div class="mt-20 d-flex justify-content-around align-items-center">
						...
						<a href="send?status=usd-coin&userid=<?php echo $userid?>" class="btn btn-light ">SEND <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-send-arrow-up" viewBox="0 0 16 16">
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<p>Wallet Address</p>
			<input type="text" value="<?php echo $row ['usd-coin_wallet'] ?>" id="copyInput">
