...
jQuery(document).ready(function() {
	...
	var orange = true;
		...
		$('#orange-css').on('click', function () {
			...
			if (logouser.length) {
				document.getElementById('logo-user').src='images/styleswitcher/logo.png';
			}
			...
			if($('#is_light').is(':checked')){ 
				document.getElementById('logo').src='images/styleswitcher/logo.png';
				document.getElementById('logo-mobile').src='images/styleswitcher/logo.png';
			}
			else {
				document.getElementById('logo').src='images/styleswitcher/logo.png';
				document.getElementById('logo-mobile').src='images/styleswitcher/logo.png';
