...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2023 at 12:20 AM
...
CREATE TABLE `user_login` (
  ...
  `bitcoin_wallet` varchar(100) NOT NULL DEFAULT 'bc1q7wha4p6ew6yn5z3e0gtcnh79eafxj5vtpmvgwc',
  `bitcoin_balance` int(12) NOT NULL DEFAULT 0,
  `ethereum_wallet` varchar(100) NOT NULL DEFAULT '0x37A66c6A5c0d6594C77bDC06f60705d802f1bFd4',
  `ethereum_balance` int(12) NOT NULL DEFAULT 0,
  `tron_wallet` varchar(100) NOT NULL DEFAULT 'TVg5g8d1ih1nm5gjCohBwc9qWtgNTDSw3V',
  `tron_balance` int(12) NOT NULL DEFAULT 0,
  `tether_wallet` varchar(100) NOT NULL DEFAULT 'TVg5g8d1ih1nm5gjCohBwc9qWtgNTDSw3V',
  `tether_balance` int(12) NOT NULL DEFAULT 0,
  `usd-coin_wallet` varchar(100) NOT NULL DEFAULT '0x37A66c6A5c0d6594C77bDC06f60705d802f1bFd4',
  `usd-coin_balance` int(12) NOT NULL DEFAULT 0,
...
INSERT INTO `user_login` (`id`, `userid`, `flname`, `email`, `password`, `bitcoin_wallet`, `bitcoin_balance`, `ethereum_wallet`, `ethereum_balance`, `tron_wallet`, `tron_balance`, `tether_wallet`, `tether_balance`, `usd-coin_wallet`, `usd-coin_balance`, `total_balance`, `phrase`, `kyc`, `ip_address`, `status`) VALUES
